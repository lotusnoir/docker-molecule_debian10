...
RUN apt-get update && apt-get -y upgrade \
    && apt-get install -y --no-install-recommends locales systemd systemd-sysv sudo python3 python3-apt python3-pip python3-setuptools net-tools procps wget ca-certificates \
